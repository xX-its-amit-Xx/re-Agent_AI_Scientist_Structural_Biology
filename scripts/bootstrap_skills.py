...
META: dict[str, dict] = {
    ...
    "binder-census": {
        "stage": "stage1_literature", "owner": "amit", "status": "implemented",
        "summary": "Everything that binds the target, classified; artefacts named; and whether "
                   "a reference binding mode exists at all.",
        "consumes": ["problem.spec", "stage1.axis_derivation", "kg.paper_nodes"],
        "produces": ["stage1.binder_census", "stage1.binding_mode", "kg.compound_nodes",
                     "kg.claim_edges"],
        "external_tools": ["rcsb-search-api", "pdbe", "chembl", "bindingdb", "drugcentral",
                           "WebSearch", "WebFetch", "paperclip"],
        "credits": [],
    },
    "relation-expand": {
        "stage": "stage1_literature", "owner": "amit", "status": "implemented",
        "summary": "Bounded outward expansion across PPI, pathway, transcriptional, RNA, "
                   "splicing, variant and drug-drug relations, with a recorded frontier.",
        "consumes": ["kg.neighbourhood", "stage1.axis_derivation", "stage1.axes"],
        "produces": ["kg.neighbourhood", "stage1.expansion_run", "kg.gene_nodes",
                     "kg.regulatory_edges"],
        "external_tools": ["intact", "biogrid", "string-db", "reactome", "signor",
                           "chip-atlas", "dorothea", "mirtarbase", "ensembl", "gnomad",
                           "clinvar", "drugbank", "chembl", "WebFetch"],
        "credits": [],
    },
    "target-neighborhood": {
        "stage": "stage1_literature", "owner": "amit", "status": "implemented",
        ...
        "consumes": ["problem.spec", "kg.paper_nodes", "kg.claim_edges", "motif.features",
                     ...
                     "stage1.binder_census", "stage1.binding_mode", "stage1.expansion_run"],
    ...
    "parts-inventory": {
        ...
        "consumes": ["problem.spec", "stage1.report", "kg.neighbourhood",
                     ...
                     "stage1.binder_census", "stage1.binding_mode"],
